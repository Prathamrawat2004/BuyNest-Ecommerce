...
const Gifts = () => {
    ...
    const fetchUnsplashImages = async () => {
        try {
            const response = await fetch(`https://api.unsplash.com/search/photos?query=presents&client_id=xOHrHJZjKnryd8O-V-8c-bBVxxxamsk9Tzm5VWdwjhM&per_page=16`);
    ...
    return (
        <>
            ...
            <div className={`first-image d-flex card-item ${darkmode ? "text-white" : ""}`}>
                <img src="/img/friend.jfif" className='rounded' height={220} width={350} alt="" />
                <div className="first-content">
                    <span className='mt-3'>RosinessDesigns(1,290)</span>
                    <h3>Gift Ideas for Best Friends</h3>
