  ...
  const fetchUnsplashImages = async () => {
    try {
      const response = await fetch(
        `https://api.unsplash.com/search/photos?query=marble&client_id=xOHrHJZjKnryd8O-V-8c-bBVxxxamsk9Tzm5VWdwjhM&per_page=16`
      );
    ...
    <>
      ...
      >
        ...
        <div className="first-content">
          ...
          <h3>
            Calacatta Viola Marble Sink With Ribbed on Three Side, Marble Sink
          </h3>
