...
const Login = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const res = await axios.post("https://buynest-ecommerce-backend-27.onrender.com/User/login", userInfo);
        ...
        <>
            <div className={`my-3 row  ${isSticky && darkmode ? "sticky nav" : "" || isSticky ? 'sticky bg-white' : ''}`}>
                <div className="nav-items d-flex justify-content-between align-items-center">
                    ...
                    {isModal && <div className={`box ${darkmode ? "text-white bg-darkmode" : " text-white bg-darkmode"}`}>
                    ...
                    <div className={`${darkmode ? "text-white" : "UserLogin content"} topper topper-1`} onClick={openLogin}>
                        <span>Login</span>
                    </div>
            ...
            <div className='container border shadow rounded d-flex flex-column justify-content-center align-items-center col-md-4 mt-5 login'>
                <div className="container">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className={`mb-2 ${darkmode ? "text-white" : ""}  d-flex flex-column`}>
                        ...
                        <div className={`d-flex justify-content-center mb-2 ${darkmode ? "text-white" : ""}`}>
                            <button className='btn btn-danger'>Login</button>
                        </div>

                        <div className='d-flex justify-content-between'>
                            <h6 className={`${darkmode ? "text-white" : ""}`}>Create new account?</h6>
