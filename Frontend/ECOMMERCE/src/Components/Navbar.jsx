        ...
        <>
                ...
                <div className="nav-items d-flex justify-content-between align-items-center">
                    ...
                    <div className="search" onClick={handleButtonClick} >
                        ...
                        <form className="input-group" onSubmit={handleSearch}>
                            ...
                            <div className="icon"><CiSearch onClick={handleSearch} /></div>
                        </form>
                    </div>
            ...
            <div div className='trend-section' >
                <div className="trends">
                    <h3 className={`text-center ${darkmode ? "text-white" : ""}`}>Check out the season's biggest trends</h3>
                </div>

                <div className={`trendContainer text-center d-flex justify-content-between align-items-center w-75 mx-auto ${darkmode ? "text-white" : ""}`} >
                    <div className="vintage-charm trend d-flex flex-column justify-content-center" onClick={handleButtonClick}>
                        <Link to="/vintage">
                            <div className="imgcontainer">
                                <img src="/img/vintage.jfif" className={`${darkmode ? "borderWhite" : ""}`} height={120} width={120} alt="vintage charm" />
                            </div>
                        </Link>
                        <p >Vintage</p>
                    ...
                    <div className="marble-furnishings trend d-flex flex-column justify-content-center" onClick={handleButtonClick}>
                        <Link to="/marble">
                            <div className="imgcontainer">
                                <img src="/img/Marble.jfif" className={`${darkmode ? "borderWhite" : ""}`} height={120} width={120} alt="marble" />
                            </div>
                        </Link>
                        <p>Marble</p>
                    ...
                    <div className="maximalist-decor trend d-flex flex-column justify-content-center" onClick={handleButtonClick}>
                        <Link to="/maximalist">
                            <div className="imgcontainer">
                                <img src="/img/maximalist.jfif" className={`${darkmode ? "borderWhite" : ""}`} height={120} width={120} alt="maximalist-decor" />
                            </div>
                        </Link>
                        <p>Maximalist</p>
                    ...
                    <div className="kids-jumpers trend d-flex flex-column justify-content-center" onClick={handleButtonClick}>
                        <Link to="/jumpers">
                            <div className="imgcontainer">
                                <img src="/img/branded.jfif" className={`${darkmode ? "borderWhite" : ""}`} height={120} width={120} alt="jumpers" />
                            </div>
                        </Link>
                        <p>Branded</p>
                    ...
                    <div className="statement-Halls-Art trend d-flex flex-column justify-content-center" onClick={handleButtonClick}>
                        <Link to="/arts">
                            <div className="imgcontainer">
                                <img src="/img/art.jfif" className={`${darkmode ? "borderWhite" : ""}`} height={120} width={120} alt="halls-art" />
                            </div>
                        </Link>
                        <p>Statement</p>
                    ...
                    <div className="best-friend-gifts trend d-flex flex-column justify-content-center" onClick={handleButtonClick}>
                        <Link to="/gifts">
                            <div className="imgcontainer">
                                <img src="/img/friend.jfif" className={`${darkmode ? "borderWhite" : ""}`} height={120} width={120} alt="friend-gifts" />
                            </div>
                        </Link>
                        <p>Best Friend</p>
                            ...
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                    <div className="d-flex">
                                        ...
                                        <div className="brand me-3">
                                            <div className="brand-img">
                                                <img src="/img/airpods.jfif" height={220} width={450} alt="" />
                                            </div>
                                            <div className="brand-title pt-2 d-flex justify-content-between mx-2">
                                                <h5>From $200</h5>
                                                <span><MdOutlineKeyboardArrowRight /></span>
                                        ...
                                        <div className="brand me-3">
                                            <div className="brand-img">
                                                <img src="/img/Nike.jfif" height={220} width={450} alt="" />
                                            </div>
                                            <div className="brand-title pt-2 d-flex justify-content-between mx-2">
                                                <h5>Upto 40% off</h5>
                                                <span><MdOutlineKeyboardArrowRight /></span>
                                ...
                                <div className="carousel-item">
                                    <div className="d-flex">
                                        <div className="brand me-3">
                                            <div className="brand-img">
                                                <img src="/img/pampers.jfif" height={220} width={450} alt="" />
                                            </div>
                                            <div className="brand-title pt-2 d-flex justify-content-between mx-2">
                                                <h5>Upto 60% off</h5>
                                                <span><MdOutlineKeyboardArrowRight /></span>
                                        ...
                                        <div className="brand me-3">
                                            <div className="brand-img">
                                                <img src="/img/Backpack.jfif" height={220} width={450} alt="" />
                                            </div>
                                            <div className="brand-title pt-2 d-flex justify-content-between mx-2">
                                                <h5>From $300</h5>
                                                <span><MdOutlineKeyboardArrowRight /></span>
