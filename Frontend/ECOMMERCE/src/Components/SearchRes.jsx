  ...
  const fetchImages = async (query) => {
    try {
      const response = await fetch(
        `https://api.unsplash.com/search/photos?query=${query}&client_id=xOHrHJZjKnryd8O-V-8c-bBVxxxamsk9Tzm5VWdwjhM&per_page=16`
      );
      ...
      >
        {images.length > 0 && (
          <img
            ...
            height={220}
            width={350}
            alt={images[0].alt_description || "Image"}
          />
        )}
          ...
          >
            ...
            <div className="card-title pt-1 pb-3 mx-1 d-flex flex-column align-items-start">
              ...
              <div className="d-flex justify-content-between align-items-center gapper">
                ...
                <div className="circle" onClick={() => handleAddToCart(image)}>
                  <BsCart className={`${darkmode ? "text-white" : ""}`} />
                </div>
              </div>
            </div>
