...
import { addToCart, removeFromCart, decreaseCart, clearCart, getTotal } from "../slices/cartSlice.js";
  ...
  return (
    <>
      ...
      <div className={`cart-container ${darkmode ? "text-white" : ""}`}>
        ...
        {cart.cartItems.length === 0 ? (<div className={`cart-empty ${darkmode ? "text-white" : ""}`}>
          <p>Your cart is currently empty</p>
          <div className='start-shopping'>
            <Link to="/" className='no-underline'>
              <span className={darkmode ? "text-white" : ""} ><FaArrowLeft /> Start Shopping</span>
            </Link>
          </div>
        </div>
        ) : (
